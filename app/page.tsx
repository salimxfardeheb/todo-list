        ...
        <div className="flex flex-col md:flex-row gap-2 items-center">
          ...
          <div className="relative w-full md:w-1/3">
            ...
            >
              {selectedCategory}
              <svg
                className={`w-3 h-3 ml-2 transition-transform ${showDropdown ? 'rotate-180' : ''}`}
          ...
          <div className="flex w-full md:w-2/3">
            <input
              ...
              required
              className="flex-grow p-2.5 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-l-lg"
            />
            <button
              type="submit"
              className="p-2.5 text-sm bg-gradient-to-bl rounded-r-lg"
            >
              <IoIosAdd size={20} />
            </button>
          </div>
